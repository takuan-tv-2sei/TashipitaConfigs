(window.webpackJsonp = window.webpackJsonp || []).push([[2, 64, 84, 139, 164, 174, 286, 290, 363, 538], {
    1434: function(t, e, n) {
        var content = n(1455);
    ...
    1441: function(t, e, n) {
        ...
        content.locals && (t.exports = content.locals);
        (0,
        n(22).default)("5b5ebe0d", content, !0, {
            sourceMap: !1
        })
    },
    1454: function(t, e, n) {
          ...
          , c = {
            ...
            methods: {
                ...
                resetWindow: function() {
                    var t = this.$refs.commonPopup;
                    if (this.initialCenterY = window.innerHeight / 2,
                    t && this.isUnderPosition) {
                        var rect = t.getBoundingClientRect();
                        rect.height > 0 ? this.initialCenterY = window.innerHeight - rect.height / 2 : this.initialCenterY = 0
                    }
                    this.initialCenterX = window.innerWidth / 2
                },
    ...
    1472: function(t, e, n) {
        var o = n(21)(!1);
        o.push([t.i, '.popup[data-v-03ba44ba]{position:fixed;width:100vw;height:100vh;top:0;left:0;pointer-events:none;color:var(--drill-font-color-black)}.popup[data-v-03ba44ba] .mediaCenter,.popup[data-v-03ba44ba] .mediaRight,.popup[data-v-03ba44ba] .mediaLeft{background-color:var(--drill-background-color-svg);outline:var(--drill-image-outline) solid var(--drill-background-color-svg)}.popup.move[data-v-03ba44ba]{background-color:transparent}.popup.minimize[data-v-03ba44ba]{background-color:transparent;pointer-events:none}.popup .popup_modal[data-v-03ba44ba]{top:0;left:0;width:200%;height:200%;background-color:#0002;pointer-events:auto;cursor:pointer}.popup .popup_modal.none[data-v-03ba44ba]{pointer-events:auto;cursor:default}.popup #common-popup[data-v-03ba44ba]{height:auto;min-width:700px;position:absolute;pointer-events:auto;top:50%;left:50%;display:flex;flex-direction:column;justify-content:flex-start;align-items:center;background-color:var(--drill-background-color-popup);transform:translate(-50%, -50%);z-index:4;transition:opacity .25s;border-radius:4px}.popup #common-popup.minimize[data-v-03ba44ba]{opacity:0;pointer-events:none}.popup #common-popup.move.transparent[data-v-03ba44ba]{opacity:.25}.popup #common-popup.move.transparent .input-area[data-v-03ba44ba],.popup #common-popup.move.transparent canvas[data-v-03ba44ba]{opacity:.25}.popup #common-popup .main[data-v-03ba44ba]{width:100%;height:auto}.popup .liftMinimizeBtn[data-v-03ba44ba]{padding:1.5rem 3rem;background-color:#7bf244;color:#fff;border:none;border-radius:10px;cursor:pointer;transition:all .3s;pointer-events:auto;position:absolute;bottom:5rem;right:5rem;z-index:-1}.popup .liftMinimizeBtn[data-v-03ba44ba]:hover{opacity:.6}.popup .header-container[data-v-03ba44ba]{display:flex;justify-content:space-between;align-items:center;padding:0 0 0 18px;position:relative;width:100%;height:52px;background-color:var(--main-color);cursor:move;border-radius:4px 4px 0 0}.popup .header-container .header-text[data-v-03ba44ba]{font-size:18px;font-family:"OT-UDShinMGoPr6N-DeBold";pointer-events:none}.popup .header-container .status-buttons[data-v-03ba44ba]{display:flex;align-items:center;pointer-events:none;justify-content:end;gap:10px;height:100%}.popup .header-container .close[data-v-03ba44ba],.popup .header-container .minimize[data-v-03ba44ba]{height:100%;width:40px;display:flex;justify-content:center;align-items:center;position:relative;z-index:5;color:#fff;pointer-events:auto;cursor:pointer;overflow:hidden}.popup .header-container .close img[data-v-03ba44ba],.popup .header-container .minimize img[data-v-03ba44ba]{cursor:pointer}.popup .header-container .close.comment-close[data-v-03ba44ba],.popup .header-container .minimize.comment-close[data-v-03ba44ba]{border-top-right-radius:4px;background-color:#fff;cursor:pointer}', ""]),
        t.exports = o
    },
    1474: function(t, e, n) {
    ...
    1614: function(t, e, n) {
        ...
        var x = {
            components: {
                No1: function() {
                    return Promise.all([n.e(3), n.e(4), n.e(6), n.e(26)]).then(n.bind(null, 2830))
                },
                No5: function() {
                    return Promise.all([n.e(14), n.e(17)]).then(n.bind(null, 3607))
                },
                No6: function() {
                    return n.e(20).then(n.bind(null, 3608))
                },
                No7: function() {
                    return n.e(21).then(n.bind(null, 3609))
                },
                No8: function() {
                    return Promise.all([n.e(22), n.e(30)]).then(n.bind(null, 3610))
                },
                No9: function() {
                    return Promise.all([n.e(16), n.e(31)]).then(n.bind(null, 3611))
                },
                No10: function() {
                    return Promise.all([n.e(18), n.e(32)]).then(n.bind(null, 3604))
                },
                No11: function() {
                    return Promise.all([n.e(12), n.e(13), n.e(15)]).then(n.bind(null, 3605))
                },
                No12: function() {
                    return Promise.all([n.e(3), n.e(4), n.e(6), n.e(23), n.e(27)]).then(n.bind(null, 2838))
                },
                No13: function() {
                    return Promise.all([n.e(3), n.e(4), n.e(6), n.e(28)]).then(n.bind(null, 2839))
                },
                No14: function() {
                    return Promise.all([n.e(19), n.e(33)]).then(n.bind(null, 3606))
                }
            },
            mixins: [h.a, m.b],
            props: {
            ...
            methods: function(t) {
                ...
                adjustUnderlineRubyForWindows: function() {
                    var t, e = w(document.querySelectorAll(".vertical .title"));
                    try {
                        for (e.s(); !(t = e.n()).done; ) {
                ...
                setHangingLetters: function() {
                    ...
                    }, n = w(document.querySelectorAll(".cmsList:not(.marked)"));
                    try {
                        for (n.s(); !(t = n.n()).done; ) {
                            var ol = t.value
                ...
                showAnswerDetail: function() { //CHECK
                    var t = this;
                    if (!this.showedAnswerDetail) {
                        var e, n = function(e, n) {
                            return t.key2Index(e, n) || 0
                        }, o = w(Object.keys(this.questionElements).filter((function(e) {
                ...
                stopSoundPlayer: function(t) {
                    if (this.$refs["sound-player"]) {
                        var e, n = w(this.$refs["sound-player"]);
                        try {
                            for (n.s(); !(e = n.n()).done; ) {
                                var o = e.value;
                ...
                mediaImageReplace: function() {
                    if (this.showedAnswerDetail) {
                        ...
                        t = t.flat(1 / 0);
                        var c, d = this.$el.querySelectorAll("main img"), h = w(t);
                        try {
                            var m = function() {
                                var t, e = c.value, n = w(Array.prototype.filter.call(d, (function(t) {
        ...
        n(12))
          , component = Object(M.a)(k, (function() {
            ...
            return o("div", {
            ...
            }) : t._e(), t.canShowScore && t.point && !t.totalOnly && t.question.answer ? o("div", {
                staticClass: "score-area"
            }, [o("div", {
                staticClass: "score-num"
            }, [t._v(t._s(t.pointScore(-1)))]), o("div", {
                staticClass: "score-total"
            }, [t._v(" /" + t._s(t.pointTotal(-1)) + "点")])]) : t._e(), t.question.child.length ? o("div", {
                ...
                return [o("div", {
                    ...
                    directives: [{
                        name: "show",
                        rawName: "v-show",
                        value: t.activeTabIndex === r || t.isLookBack || t.isMarking || t.isHomeWork,
                        expression: "activeTabIndex === idx || isLookBack || isMarking || isHomeWork"
                    }],
                ...
                }) : t._e(), t.canShowScore && t.point && !t.totalOnly && !e.child.length && e.answer ? o("div", {
                    staticClass: "score-area"
                }, [o("div", {
                    staticClass: "score-num"
                }, [t._v(t._s(t.pointScore(r)))]), o("div", {
                    staticClass: "score-total"
                }, [t._v(" /" + t._s(t.pointTotal(r)) + "点")])]) : t._e(), t._l(e.child, (function(l, c) {
                    return o("div", {
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                    ...
                    }) : t._e(), t.canShowScore && t.point && !t.totalOnly && l.answer ? o("div", {
                        staticClass: "score-area"
                    }, [o("div", {
                        staticClass: "score-num"
                    }, [t._v(t._s(t.pointScore(r, c)))]), o("div", {
                        staticClass: "score-total"
                    }, [t._v(" /" + t._s(t.pointTotal(r, c)) + "点")])]) : t._e()], 1)
                }
                ))], 2)]
            }
            ))], 2) : t._e(), t.canShowScore && t.point && t.totalOnly ? o("div", {
                staticClass: "score-area"
            }, [o("div", {
                staticClass: "score-num"
            }, [t._v(t._s(t.point.score))]), o("div", {
                staticClass: "score-total"
            }, [t._v(" /" + t._s(t.point.total) + "点")])]) : t._e(), t.hideFooter ? t._e() : o("drill-footer", {
                ref: "footer",
                attrs: {
                    problems: t.problems,
        ...
        ), [], !1, null, "54b3864f", null);
        e.default = component.exports;
        installComponents(component, {
            SoundPlayer: n(1636).default,
            DrillFooter: n(2127).default,
    ...
    1856: function(t, e, n) {
        ...
        content.locals && (t.exports = content.locals);
        (0,
        n(22).default)("b1c2f81e", content, !0, {
            sourceMap: !1
        })
    },
    1857: function(t, e, n) {
        ...
        content.locals && (t.exports = content.locals);
        (0,
        n(22).default)("5f0af172", content, !0, {
            sourceMap: !1
        })
    },
    1858: function(t, e) {
    ...
    2169: function(t, e, n) {
        var o = n(21)
          ...
          , h = r(l)
          , m = r(c);
        d.push([t.i, ".main[data-v-54b3864f]{position:relative;padding:20px 90px 150px min(50px,4.5%);overflow:hidden;font-family:var(--drill-font-alphabet),var(--bs-font-default);min-height:calc(100vh - var(--header-height) - 56px);min-height:calc(var(--vh, 1vh)*100 - var(--header-height) - 56px)}.main[data-v-54b3864f]  b{font-family:var(--drill-font-alphabet-bold),var(--bs-font-default-bold);font-weight:500 !important}.main[data-v-54b3864f] .mediaRight{margin-left:auto}.main[data-v-54b3864f] .mediaCenter{margin:0 auto}.main[data-v-54b3864f]  img+br+img{margin-top:2rem}.main[data-v-54b3864f]  img+img{margin-left:2rem}.main[data-v-54b3864f] .mediaCenter,.main[data-v-54b3864f] .mediaRight,.main[data-v-54b3864f] .mediaLeft{margin:var(--drill-image-outline);background-color:var(--drill-background-color-svg);outline:var(--drill-image-outline) solid var(--drill-background-color-svg)}.main[data-v-54b3864f] .cmsFontSansSerif,.main[data-v-54b3864f] .”cmsFontSansSerif”{font-family:var(--drill-font-alphabet-gothic),var(--bs-font-sans-serif)}.main[data-v-54b3864f] .cmsFontSansSerif b,.main[data-v-54b3864f] .”cmsFontSansSerif” b{font-family:var(--drill-font-alphabet-gb),var(--bs-font-sans-serif-bold)}.main.vertical.ios16[data-v-54b3864f]  .title-container .title rt:has(ruby),.main.vertical.ios17Limit[data-v-54b3864f]  .title-container .title rt:has(ruby){transform:translateX(-0.01rem)}.main.vertical.chromeOS[data-v-54b3864f]  .answer-text .alphabet,.main.vertical.chromeOS[data-v-54b3864f]  .explanation-text .alphabet{left:.1rem !important}.main.vertical[data-v-54b3864f] .cmsRectangle,.main.vertical[data-v-54b3864f] .”cmsRectangle”{font-family:var(--bs-font-default)}.main.vertical[data-v-54b3864f] .cmsRectangle .alphabet,.main.vertical[data-v-54b3864f] .”cmsRectangle” .alphabet{font-family:var(--drill-font-alphabet),var(--bs-font-default)}.main.vertical[data-v-54b3864f] .cmsRectangle ::v-deep b,.main.vertical[data-v-54b3864f] .”cmsRectangle” ::v-deep b{font-family:var(--bs-font-default-bold)}.main.vertical[data-v-54b3864f] .cmsRectangle ::v-deep b .alphabet,.main.vertical[data-v-54b3864f] .”cmsRectangle” ::v-deep b .alphabet{font-family:var(--drill-font-alphabet-bold),var(--bs-font-default-bold)}.main.vertical[data-v-54b3864f] .cmsFontSansSerif ::v-deep.cmsRectangle,.main.vertical[data-v-54b3864f] .cmsFontSansSerif ::v-deep.”cmsRectangle”,.main.vertical[data-v-54b3864f] .”cmsFontSansSerif” ::v-deep.cmsRectangle,.main.vertical[data-v-54b3864f] .”cmsFontSansSerif” ::v-deep.”cmsRectangle”{font-family:var(--bs-font-sans-serif)}.main.vertical[data-v-54b3864f] .cmsFontSansSerif ::v-deep.cmsRectangle .alphabet,.main.vertical[data-v-54b3864f] .cmsFontSansSerif ::v-deep.”cmsRectangle” .alphabet,.main.vertical[data-v-54b3864f] .”cmsFontSansSerif” ::v-deep.cmsRectangle .alphabet,.main.vertical[data-v-54b3864f] .”cmsFontSansSerif” ::v-deep.”cmsRectangle” .alphabet{font-family:var(--drill-font-alphabet-gothic),var(--bs-font-sans-serif)}.main.vertical[data-v-54b3864f] .cmsFontSansSerif ::v-deep.cmsRectangle ::v-deep b,.main.vertical[data-v-54b3864f] .cmsFontSansSerif ::v-deep.”cmsRectangle” ::v-deep b,.main.vertical[data-v-54b3864f] .”cmsFontSansSerif” ::v-deep.cmsRectangle ::v-deep b,.main.vertical[data-v-54b3864f] .”cmsFontSansSerif” ::v-deep.”cmsRectangle” ::v-deep b{font-family:var(--bs-font-sans-serif-bold)}.main.vertical[data-v-54b3864f] .cmsFontSansSerif ::v-deep.cmsRectangle ::v-deep b .alphabet,.main.vertical[data-v-54b3864f] .cmsFontSansSerif ::v-deep.”cmsRectangle” ::v-deep b .alphabet,.main.vertical[data-v-54b3864f] .”cmsFontSansSerif” ::v-deep.cmsRectangle ::v-deep b .alphabet,.main.vertical[data-v-54b3864f] .”cmsFontSansSerif” ::v-deep.”cmsRectangle” ::v-deep b .alphabet{font-family:var(--drill-font-alphabet-gb),var(--bs-font-sans-serif-bold)}.main.vertical .title-container[data-v-54b3864f]  .alphabet{left:.3rem}.main[data-v-54b3864f]  .cmsDialog1 .cmsDialog__row,.main[data-v-54b3864f]  .cmsDialog1 .”cmsDialog__row”,.main[data-v-54b3864f]  .”cmsDialog1” .cmsDialog__row,.main[data-v-54b3864f]  .”cmsDialog1” .”cmsDialog__row”{display:grid;grid-template-columns:6rem 2rem 1fr;justify-content:center;align-items:baseline}.main[data-v-54b3864f]  .cmsDialog1 .cmsDialog__column,.main[data-v-54b3864f]  .cmsDialog1 .”cmsDialog__column”,.main[data-v-54b3864f]  .”cmsDialog1” .cmsDialog__column,.main[data-v-54b3864f]  .”cmsDialog1” .”cmsDialog__column”{display:grid;grid-template-rows:6rem 2rem 1fr;justify-content:center;align-items:center}.main[data-v-54b3864f]  .markingIconBase{position:absolute;width:100%;height:100%;top:0;right:0;left:0;bottom:0}.main[data-v-54b3864f]  .markingIcon{position:absolute;display:flex;justify-content:center;width:32px;height:32px;top:0px;transform:translate(-50%, -60%);background-color:var(--main-color);border-radius:50%;outline:1px solid #fff;outline-offset:-1px}.main.vertical[data-v-54b3864f]  .markingIconBase{position:unset}.main.vertical[data-v-54b3864f]  .markingIcon{transform:translate(50%, -46%)}.main.vertical[data-v-54b3864f]  ol.cmsList{padding-top:0;padding-left:0}.main.vertical[data-v-54b3864f]  ol.cmsList li{list-style:none;counter-increment:cmslist;margin-top:2.5rem;margin-left:.5rem;position:relative;line-height:2.8rem}.main.vertical[data-v-54b3864f]  ol.cmsList li .hangingLetter{top:-2.5rem;right:0;position:absolute}.main.vertical[data-v-54b3864f]  ol.cmsList.type1 li:has(ruby) .hangingLetter{padding-right:.5rem}.main[data-v-54b3864f]:not(.vertical)  ol.cmsList li{list-style:none;counter-increment:cmslist;margin-left:2.5rem;position:relative}.main[data-v-54b3864f]:not(.vertical)  ol.cmsList li .hangingLetter{left:-2.5rem;position:absolute;top:0}.main[data-v-54b3864f]  ol.cmsList li{list-style:none;margin-left:2.5rem;position:relative}.main.vertical[data-v-54b3864f] .cmsUnderlineDashed,.main.vertical[data-v-54b3864f] .”cmsUnderlineDashed”{border-right:.15rem dashed !important}.main.vertical[data-v-54b3864f] .cmsUnderlineDouble,.main.vertical[data-v-54b3864f] .”cmsUnderlineDouble”{border-right:.2rem double !important}.main.vertical[data-v-54b3864f] .cmsUnderlineWavy,.main.vertical[data-v-54b3864f] .”cmsUnderlineWavy”{border-right:none !important;background:url(" + h + ") repeat-y right top/auto .65rem;padding-right:.5rem !important;text-decoration:none;text-decoration-skip-ink:none}.main.vertical[data-v-54b3864f] .title-container .title .cmsRoundRectangle,.main.vertical[data-v-54b3864f] .title-container .title .”cmsRoundRectangle”{line-height:3.425rem}.main.vertical[data-v-54b3864f] .title-container .title .cmsRoundRectangle>.cmsRectangle,.main.vertical[data-v-54b3864f] .title-container .title .cmsRoundRectangle>.”cmsRectangle”,.main.vertical[data-v-54b3864f] .title-container .title .”cmsRoundRectangle”>.cmsRectangle,.main.vertical[data-v-54b3864f] .title-container .title .”cmsRoundRectangle”>.”cmsRectangle”{transform:translateX(0.35rem);margin-left:0}.main.vertical[data-v-54b3864f] .title-container .title .cmsRoundRectangle>.cmsRectangle .alphabet,.main.vertical[data-v-54b3864f] .title-container .title .cmsRoundRectangle>.”cmsRectangle” .alphabet,.main.vertical[data-v-54b3864f] .title-container .title .”cmsRoundRectangle”>.cmsRectangle .alphabet,.main.vertical[data-v-54b3864f] .title-container .title .”cmsRoundRectangle”>.”cmsRectangle” .alphabet{left:0rem}.main.vertical[data-v-54b3864f] .title-container .title .cmsRoundRectangle .alphabet,.main.vertical[data-v-54b3864f] .title-container .title .”cmsRoundRectangle” .alphabet{left:.3rem}.main.vertical[data-v-54b3864f] .title-container .title .cmsRoundRectangle ruby:has(.alphabet) rt,.main.vertical[data-v-54b3864f] .title-container .title .”cmsRoundRectangle” ruby:has(.alphabet) rt{transform:translateX(0.1rem)}.main.vertical[data-v-54b3864f]  .title-container .title u{text-decoration:none;border-right:.15rem solid;text-decoration-skip-ink:none;padding-right:.32rem}.main.vertical[data-v-54b3864f]  .title-container .title .kanbun u,.main.vertical[data-v-54b3864f]  .title-container .title .kakikudashi u{padding-right:.15rem}.main.vertical[data-v-54b3864f]  .choice-table-container .value u{text-decoration:none;border-right:.15rem solid;text-decoration-skip-ink:none;padding-right:.32rem}.main.vertical[data-v-54b3864f]  .choice-table-container .value u rt{position:relative;transform:translateX(0.3325rem)}.main.vertical[data-v-54b3864f]  .choice-table-container .value u rt rt{transform:translateX(-0.1rem)}.main.vertical[data-v-54b3864f]  .title-container .title rt{position:relative;transform:translateX(0.42rem)}.main.vertical[data-v-54b3864f]  .title-container .title rt rt{transform:translateX(-0.01rem)}.main.vertical[data-v-54b3864f]  ol.cmsList.type0{margin-left:0;padding-left:0}.main.vertical[data-v-54b3864f]  ol.cmsList.type3{margin-bottom:0}.main.vertical[data-v-54b3864f]  ol.cmsList.type3 .hangingLetter{top:-2.5rem !important;text-combine-upright:all;-webkit-text-combine:horizontal}.main.vertical[data-v-54b3864f]  ol.cmsList.type3 li:not(:has(ruby)) .hangingLetter{right:-0.2rem}.main.vertical[data-v-54b3864f]  ol.cmsList.type3 ruby{line-height:unset}.main.vertical[data-v-54b3864f]  ol.cmsList.type3 li:has(ruby) .hangingLetter{right:.2rem}.main.vertical[data-v-54b3864f]  ol.cmsList.type3 li:has(ruby>rt>ruby) .hangingLetter{right:.8rem}.main.vertical[data-v-54b3864f]  ol.cmsList.type5 .hangingLetter{writing-mode:horizontal-tb;top:-3.25rem;left:0rem;width:2.5rem;display:block;text-align:center}.main.vertical[data-v-54b3864f]  ol.cmsList.type6 .hangingLetter{writing-mode:horizontal-tb;top:-3.25rem;left:0rem;width:2.5rem;display:block;text-align:center}.main[data-v-54b3864f]:not(.vertical) .cmsUnderlineDashed,.main[data-v-54b3864f]:not(.vertical) .”cmsUnderlineDashed”{border-bottom:.15rem dashed !important}.main[data-v-54b3864f]:not(.vertical) .cmsUnderlineDouble,.main[data-v-54b3864f]:not(.vertical) .”cmsUnderlineDouble”{border-bottom:.15rem double !important}.main[data-v-54b3864f]:not(.vertical) .cmsUnderlineWavy,.main[data-v-54b3864f]:not(.vertical) .”cmsUnderlineWavy”{border-bottom:none !important;background:url(" + m + ') repeat-x bottom left/auto .5rem;padding-bottom:.4rem;text-decoration:none;text-decoration-skip-ink:none}.main[data-v-54b3864f]:not(.vertical)  .title-container .title u{text-decoration:none;border-bottom:.15rem solid;text-decoration-skip-ink:none}.main[data-v-54b3864f]:not(.vertical)  .title-container .title u rt{position:relative}.main:not(.vertical) .title-container>.title[data-v-54b3864f] .cmsFontSansSerif,.main:not(.vertical) .title-container>.title[data-v-54b3864f] .”cmsFontSansSerif”{display:inline-block}.main:not(.vertical) .question>.title-container[data-v-54b3864f]{align-items:baseline}.main:not(.vertical) .question>.title-container>.title[data-v-54b3864f] .cmsFontSansSerif,.main:not(.vertical) .question>.title-container>.title[data-v-54b3864f] .”cmsFontSansSerif”{display:inline}.main[data-v-54b3864f] .cmsRectangle,.main[data-v-54b3864f] .”cmsRectangle”{border:2px var(--drill-rectangle-color) solid;display:inline-block;padding:.25rem 0;min-width:2.375rem;line-height:3.15rem}.main[data-v-54b3864f] .cmsRectangle:has(:not(.alphabet)),.main[data-v-54b3864f] .”cmsRectangle”:has(:not(.alphabet)){padding:1rem 0;width:unset}.main[data-v-54b3864f] .cmsRectangle .alphabet,.main[data-v-54b3864f] .”cmsRectangle” .alphabet{position:relative;top:.1rem;left:.3rem}.main[data-v-54b3864f] .cmsRoundRectangle,.main[data-v-54b3864f] .”cmsRoundRectangle”{border:2px var(--drill-rectangle-color) solid;border-radius:1rem;display:inline-block;padding:.25rem 0;min-width:2.375rem;line-height:3.15rem;max-width:100%}.main[data-v-54b3864f] .cmsRoundRectangle:has(:not(.alphabet)),.main[data-v-54b3864f] .”cmsRoundRectangle”:has(:not(.alphabet)){padding:1rem .7rem .5rem .7rem;width:unset}.main[data-v-54b3864f] .cmsRoundRectangle .alphabet,.main[data-v-54b3864f] .”cmsRoundRectangle” .alphabet{position:relative;top:.25rem;left:.3rem}.main.vertical[data-v-54b3864f] .cmsRectangle,.main.vertical[data-v-54b3864f] .”cmsRectangle”{line-height:2.375rem;margin-left:.5rem;transform:translateX(0.25rem)}.main.vertical[data-v-54b3864f] .cmsRectangle:not(:has(ol.cmsList)):has(ruby>rt),.main.vertical[data-v-54b3864f] .”cmsRectangle”:not(:has(ol.cmsList)):has(ruby>rt){padding-right:1rem;line-height:3.15rem}.main.vertical .middle-container[data-v-54b3864f] :has(.choice-table-container) .cmsRectangle,.main.vertical .middle-container[data-v-54b3864f] :has(.choice-table-container) .”cmsRectangle”,.main.vertical .middle-container[data-v-54b3864f] :has(.choice-table-container) .cmsRoundRectangle,.main.vertical .middle-container[data-v-54b3864f] :has(.choice-table-container) .”cmsRoundRectangle”{margin-left:.6rem;transform:translateX(0.3rem);padding:.15rem .15rem;min-width:1.8rem;line-height:unset;line-height:1.8rem}.main.vertical .middle-container[data-v-54b3864f] :has(.choice-table-container) .cmsRectangle:has(:not(.alphabet)),.main.vertical .middle-container[data-v-54b3864f] :has(.choice-table-container) .”cmsRectangle”:has(:not(.alphabet)),.main.vertical .middle-container[data-v-54b3864f] :has(.choice-table-container) .cmsRoundRectangle:has(:not(.alphabet)),.main.vertical .middle-container[data-v-54b3864f] :has(.choice-table-container) .”cmsRoundRectangle”:has(:not(.alphabet)){padding:1rem .5rem .5rem .5rem}.main.vertical .middle-container[data-v-54b3864f] :has(.choice-table-container) .cmsRectangle .alphabet,.main.vertical .middle-container[data-v-54b3864f] :has(.choice-table-container) .”cmsRectangle” .alphabet,.main.vertical .middle-container[data-v-54b3864f] :has(.choice-table-container) .cmsRoundRectangle .alphabet,.main.vertical .middle-container[data-v-54b3864f] :has(.choice-table-container) .”cmsRoundRectangle” .alphabet{left:0;top:.25rem}.main.vertical[data-v-54b3864f] .kanbun .cmsRectangle,.main.vertical[data-v-54b3864f] .kanbun .”cmsRectangle”,.main.vertical[data-v-54b3864f] .kanbun .cmsRoundRectangle,.main.vertical[data-v-54b3864f] .kanbun .”cmsRoundRectangle”,.main.vertical[data-v-54b3864f] .kakikudashi .cmsRectangle,.main.vertical[data-v-54b3864f] .kakikudashi .”cmsRectangle”,.main.vertical[data-v-54b3864f] .kakikudashi .cmsRoundRectangle,.main.vertical[data-v-54b3864f] .kakikudashi .”cmsRoundRectangle”{padding:.25rem 0;width:2.6rem;line-height:2rem}.main.vertical[data-v-54b3864f] .kanbun .cmsRectangle:has(:not(.alphabet)),.main.vertical[data-v-54b3864f] .kanbun .”cmsRectangle”:has(:not(.alphabet)),.main.vertical[data-v-54b3864f] .kanbun .cmsRoundRectangle:has(:not(.alphabet)),.main.vertical[data-v-54b3864f] .kanbun .”cmsRoundRectangle”:has(:not(.alphabet)),.main.vertical[data-v-54b3864f] .kakikudashi .cmsRectangle:has(:not(.alphabet)),.main.vertical[data-v-54b3864f] .kakikudashi .”cmsRectangle”:has(:not(.alphabet)),.main.vertical[data-v-54b3864f] .kakikudashi .cmsRoundRectangle:has(:not(.alphabet)),.main.vertical[data-v-54b3864f] .kakikudashi .”cmsRoundRectangle”:has(:not(.alphabet)){padding:1rem .5rem .5rem .5rem}.main.vertical[data-v-54b3864f] .kanbun .cmsRectangle .alphabet,.main.vertical[data-v-54b3864f] .kanbun .”cmsRectangle” .alphabet,.main.vertical[data-v-54b3864f] .kanbun .cmsRoundRectangle .alphabet,.main.vertical[data-v-54b3864f] .kanbun .”cmsRoundRectangle” .alphabet,.main.vertical[data-v-54b3864f] .kakikudashi .cmsRectangle .alphabet,.main.vertical[data-v-54b3864f] .kakikudashi .”cmsRectangle” .alphabet,.main.vertical[data-v-54b3864f] .kakikudashi .cmsRoundRectangle .alphabet,.main.vertical[data-v-54b3864f] .kakikudashi .”cmsRoundRectangle” .alphabet{left:.33rem}.main.vertical[data-v-54b3864f] .kanbun sub,.main.vertical[data-v-54b3864f] .kakikudashi sub{left:unset !important;right:unset !important}.main.vertical[data-v-54b3864f] .cmsRoundRectangle>.cmsRectangle,.main.vertical[data-v-54b3864f] .cmsRoundRectangle>.”cmsRectangle”,.main.vertical[data-v-54b3864f] .”cmsRoundRectangle”>.cmsRectangle,.main.vertical[data-v-54b3864f] .”cmsRoundRectangle”>.”cmsRectangle”{transform:translateX(0);margin-left:0 !important}.main.vertical[data-v-54b3864f] .cmsRoundRectangle ruby:has(rt>ruby),.main.vertical[data-v-54b3864f] .”cmsRoundRectangle” ruby:has(rt>ruby){line-height:6rem;line-height:3.425rem}.main[data-v-54b3864f]:not(.vertical) .cmsRectangle,.main[data-v-54b3864f]:not(.vertical) .”cmsRectangle”,.main[data-v-54b3864f]:not(.vertical) .cmsRoundRectangle,.main[data-v-54b3864f]:not(.vertical) .”cmsRoundRectangle”{width:unset;min-height:2.6rem;padding:.5rem .5rem 0;line-height:2.74rem;margin-bottom:.5rem}.main[data-v-54b3864f]:not(.vertical) .cmsRectangle:has(:not(.alphabet)),.main[data-v-54b3864f]:not(.vertical) .”cmsRectangle”:has(:not(.alphabet)),.main[data-v-54b3864f]:not(.vertical) .cmsRoundRectangle:has(:not(.alphabet)),.main[data-v-54b3864f]:not(.vertical) .”cmsRoundRectangle”:has(:not(.alphabet)){padding:1rem .5rem .5rem .5rem;height:unset;line-height:unset}.main[data-v-54b3864f]:not(.vertical) .cmsRectangle .alphabet,.main[data-v-54b3864f]:not(.vertical) .”cmsRectangle” .alphabet,.main[data-v-54b3864f]:not(.vertical) .cmsRoundRectangle .alphabet,.main[data-v-54b3864f]:not(.vertical) .”cmsRoundRectangle” .alphabet{position:relative;top:.25rem;left:.3rem}.preview-font .main[data-v-54b3864f]{--bs-font-sans-serif-bold: "OT-UDShinMGoPr6N-DeBold"}.preview-font .main[data-v-54b3864f] .cmsFontSansSerif,.preview-font .main[data-v-54b3864f] .”cmsFontSansSerif”{font-family:var(--bs-font-sans-serif-bold)}.question[data-v-54b3864f]{position:relative;width:100%;height:100%}.child-container .title-container:has(.no) .title[data-v-54b3864f]{margin-left:unset}.title-container:has(.question-no) .title[data-v-54b3864f]  .cmsFontSansSerif ruby>rt,.title-container:has(.question-no) .title[data-v-54b3864f]  .”cmsFontSansSerif” ruby>rt{transform:translateY(-0.1rem)}.title-container:has(.question-no) .chapter-memo[data-v-54b3864f]{position:absolute;width:49px;height:42px;z-index:100;pointer-events:auto !important;cursor:pointer;left:-4px;top:46px}.title-container:has(.question-no) .chapter-memo[data-v-54b3864f]:hover{transform:scale(1.08)}.title-container:has(.question-no) .chapter-memo.inactive[data-v-54b3864f]{display:none}.vertical .title-container:has(.question-no) .title[data-v-54b3864f]  .cmsFontSansSerif ruby>rt,.vertical .title-container:has(.question-no) .title[data-v-54b3864f]  .”cmsFontSansSerif” ruby>rt{transform:unset}.vertical .title-container:has(.question-no) .chapter-memo[data-v-54b3864f]{right:46px;top:-4px}.title-container[data-v-54b3864f]{display:flex;align-items:start}.title-container .question-no[data-v-54b3864f]{margin-top:.4rem;background-color:var(--main-color);color:#fff;font-size:1.5rem;line-height:2.375rem;text-align:center;min-width:2.375rem;height:2.375rem;font-family:var(--bs-font-default);position:relative}.title-container .no[data-v-54b3864f]{line-height:3.125rem;min-width:3.797rem;font-size:1.625rem;line-break:strict;word-break:break-word;overflow-wrap:break-word;word-wrap:break-word;text-align:center}.title-container .no[data-v-54b3864f]  dl{display:grid;grid-template-columns:2rem 1fr;column-gap:1.25rem;margin-top:2rem}.title-container .title[data-v-54b3864f]{line-height:3.125rem;font-size:1.625rem;line-break:strict;word-break:break-word;overflow-wrap:break-word;word-wrap:break-word}.title-container .title[data-v-54b3864f]  dl{display:grid;grid-template-columns:2rem 1fr;column-gap:1.25rem;margin-top:2rem}.title-container[data-v-54b3864f]  .cmsBlankBox{display:inline;word-break:break-all;border:2px var(--drill-rectangle-color) solid;min-width:5rem;height:2.5rem;padding:0 .625rem;text-align:center;position:relative}.title-container[data-v-54b3864f]  .cmsBlankBox:empty{display:inline-block;top:.7rem}.title-container[data-v-54b3864f]  .cmsBlankBox.size1{min-width:9.75rem;line-height:3.5rem}.title-container[data-v-54b3864f]  .cmsBlankBox.size2{min-width:16.25rem;line-height:3.5rem}.title-container[data-v-54b3864f]  .cmsBlankBox.size3,.title-container[data-v-54b3864f]  .cmsBlankBox.size4,.title-container[data-v-54b3864f]  .cmsBlankBox.size5{min-width:26rem;line-height:3.5rem}.vertical .child-container .title-container .title[data-v-54b3864f]{margin-left:unset}.vertical .title-container[data-v-54b3864f]{display:flex;align-items:baseline}.vertical .title-container .question-no[data-v-54b3864f]{min-height:2.375rem}.vertical .title-container .title[data-v-54b3864f]{margin-left:1.5rem;transform:translateX(-0.25rem)}.vertical .title-container .title[data-v-54b3864f]  .cmsBlankBox{flex:1;min-width:unset;height:unset;width:2.5rem;min-height:5rem;padding:.625rem 0}.vertical .title-container .title[data-v-54b3864f]  .cmsBlankBox:empty{top:0}.vertical .title-container .title[data-v-54b3864f]  .cmsBlankBox.size1{min-height:9.75rem}.vertical .title-container .title[data-v-54b3864f]  .cmsBlankBox.size2{min-height:16.25rem}.vertical .title-container .title[data-v-54b3864f]  .cmsBlankBox.size3,.vertical .title-container .title[data-v-54b3864f]  .cmsBlankBox.size4,.vertical .title-container .title[data-v-54b3864f]  .cmsBlankBox.size5{min-height:26rem}.nav-tabs[data-v-54b3864f]{column-gap:.5rem;border-bottom:2px #2670fb solid;margin-top:1.25rem}.nav-tabs .nav-link[data-v-54b3864f]{min-width:8.75rem;font-size:1.25rem;border-color:#2699fb;border-width:2px;border-bottom:unset;text-align:center;font-weight:bold;cursor:pointer}.nav-tabs .nav-link.active[data-v-54b3864f]{background-color:#2699fb;border-color:#2670fb;color:#fff}.nav-tabs .nav-item[data-v-54b3864f]{position:relative}.nav-tabs .nav-item .attension-icon[data-v-54b3864f],.nav-tabs .nav-item .answered-icon[data-v-54b3864f],.nav-tabs .nav-item .correct-icon[data-v-54b3864f],.nav-tabs .nav-item .incorrect-icon[data-v-54b3864f]{width:1.875rem;height:1.875rem;font-size:1.5rem;line-height:1.875rem;font-weight:bold;color:#fff;background-color:#e36a63;border-radius:50%;position:absolute;right:.25rem;top:-1rem;display:flex;justify-content:center;align-items:center}.nav-tabs .nav-item .answered-icon[data-v-54b3864f]{font-size:1.75rem;background-color:#6fe06f}.nav-tabs .nav-item .correct-icon[data-v-54b3864f]{font-size:1.75rem;color:#ff4748;background-color:transparent}.nav-tabs .nav-item .incorrect-icon[data-v-54b3864f]{font-size:3.75rem;color:#2699fb;background-color:transparent}.answer-button-container[data-v-54b3864f]{position:fixed;bottom:0;left:0;width:100%;display:flex;pointer-events:none}.answer-button-container .answer-detail-button[data-v-54b3864f],.answer-button-container .answer-button[data-v-54b3864f],.answer-button-container .next-button[data-v-54b3864f]{margin-left:auto;color:#fff;background-color:#4999f3;border-radius:5px;text-align:center;width:255px;height:75px;font-size:20px;line-height:75px;cursor:pointer;pointer-events:auto}.answer-button-container .answer-detail-button[data-v-54b3864f]{margin-left:unset}.answer-button-container .next-button[data-v-54b3864f]{background-color:#f1b349}.answer-button-container .next-button.disabled[data-v-54b3864f]{pointer-events:none;cursor:unset;background-color:#949494}.answer-button-container .answer-button[data-v-54b3864f]{position:relative}.answer-button-container .answer-button .alert-text[data-v-54b3864f]{position:absolute;width:100%;left:50%;transform:translateX(-45%);top:-30px;font-size:20px;line-height:22px;font-weight:bold;color:#000}.answer-button-container .answer-button .alert-icon[data-v-54b3864f]{position:absolute;background-color:#f7ea54;width:46px;height:46px;border-radius:50%;box-shadow:0px 3px 6px #00000029;left:-23px;top:-23px;color:#000;font-size:24px;font-weight:bold;display:flex;justify-content:center;align-items:center}[data-v-54b3864f] .degree{display:inline-block;letter-spacing:-1rem}[data-v-54b3864f] .answer-text .degree{letter-spacing:unset;transform:unset}[data-v-54b3864f] .answer-correct{pointer-events:none}.page-count-container[data-v-54b3864f]{position:fixed;top:5px;right:140px}.page-count-container .text[data-v-54b3864f]{font-size:1.5rem;color:#3ad739}.vertical[data-v-54b3864f]:not([class^=no]){overflow-y:hidden;max-height:calc(100vh - var(--header-height));max-height:calc(var(--vh, 1vh)*100 - var(--header-height));padding:10px 0;padding-bottom:80px}.vertical:not([class^=no]) .question[data-v-54b3864f]{padding:0 max(90px,6%);writing-mode:vertical-rl;overflow-x:scroll;overflow-y:hidden}.vertical:not([class^=no]) .question[data-v-54b3864f]::-webkit-scrollbar{display:none}.vertical:not([class^=no]) .question[data-v-54b3864f] .alphabet{text-combine-upright:all;-webkit-text-combine:horizontal;position:relative;left:0;text-align:center;top:.25rem}.vertical:not([class^=no]) .question[data-v-54b3864f]  .select-container .alphabet{top:0}.vertical:not([class^=no]) .question .question-no[data-v-54b3864f]{text-orientation:upright;text-combine-upright:all;-webkit-text-combine:horizontal;width:fit-content;padding-right:.15rem}.vertical:not([class^=no]) .question .title[data-v-54b3864f] .alphabet{text-combine-upright:all;-webkit-text-combine:horizontal}.vertical:not([class^=no]) .question .title-container>.title[data-v-54b3864f]:not(.kanbun):has(ruby>rt>ruby)  .cmsRectangle,.vertical:not([class^=no]) .question .title-container>.title[data-v-54b3864f]:not(.kanbun):has(ruby>rt>ruby)  .cmsRoundRectangle,.vertical:not([class^=no]) .question .title-container>.title[data-v-54b3864f]:not(.kakikudashi):has(ruby>rt>ruby)  .cmsRectangle,.vertical:not([class^=no]) .question .title-container>.title[data-v-54b3864f]:not(.kakikudashi):has(ruby>rt>ruby)  .cmsRoundRectangle{margin-left:1.2rem}.vertical:not([class^=no]) .question[data-v-54b3864f] .bracketed-character{text-combine-upright:all;-webkit-text-combine:horizontal;display:inline-block;transform:translateX(0.2rem)}.vertical:not([class^=no]) .question[data-v-54b3864f]  sub{top:0;right:-1rem;bottom:.125rem;left:.96875rem}.vertical:not([class^=no]) .question .nav-tabs[data-v-54b3864f]{column-gap:.5rem;border-bottom:none;border-left:2px #2670fb solid;margin-top:1.25rem}.vertical:not([class^=no]) .question .nav-tabs .nav-link[data-v-54b3864f]{text-orientation:upright;text-combine-upright:all;-webkit-text-combine:horizontal;height:5rem;min-width:1.25rem;border-bottom:2px #2699fb solid;border-left:unset;border-top-left-radius:unset;border-bottom-right-radius:.25rem}.vertical:not([class^=no]) .question .nav-tabs .nav-link.active[data-v-54b3864f]{background-color:#2699fb;border-color:#2670fb;color:#fff}.vertical:not([class^=no]) .question .nav-tabs .nav-item .attension-icon[data-v-54b3864f],.vertical:not([class^=no]) .question .nav-tabs .nav-item .answered-icon[data-v-54b3864f]{text-orientation:upright;text-combine-upright:all;top:.25rem;right:-1rem}.vertical:not([class^=no]) .question .answer-button-container[data-v-54b3864f],.vertical:not([class^=no]) .question .action-container[data-v-54b3864f]{writing-mode:initial}.vertical:not([class^=no]) .page-count-container[data-v-54b3864f]{writing-mode:initial}.vertical[data-v-54b3864f]:not([class^=no])  img+br+img{margin-right:2rem}.vertical[data-v-54b3864f]:not([class^=no])  img+img{margin-top:2rem}.vertical[data-v-54b3864f]:not([class^=no])  span.cmsBlankBox{vertical-align:baseline !important}.vertical[data-v-54b3864f]:not([class^=no])  .explanation-text>img{vertical-align:unset}.vertical[data-v-54b3864f]:not([class^=no])  .explanation-text>img+img{margin-top:unset;margin-left:unset}[data-v-54b3864f] .title-container .title .cmsTable th,[data-v-54b3864f] .title-container .title .”cmsTable” th{text-align:center;border:2px #000 solid}[data-v-54b3864f] .title-container .title .cmsTable tr,[data-v-54b3864f] .title-container .title .”cmsTable” tr{border:2px #000 solid}[data-v-54b3864f] .title-container .title .cmsTable tr td,[data-v-54b3864f] .title-container .title .”cmsTable” tr td{padding:0 1.25rem;border:2px #000 solid;text-align:center}[data-v-54b3864f] .title-container .title ruby .mjxRuby{transform:translateY(-0.4rem) !important}[data-v-54b3864f] .title-container .title sub{font-size:1.3rem;top:.5rem}[data-v-54b3864f] .vertical u rt{transform:translateX(0.3rem)}[data-v-54b3864f] .vertical u.cmsUnderlineWavy rt,[data-v-54b3864f] .vertical u.cmsUnderlineDouble rt,[data-v-54b3864f] .vertical u.cmsUnderlineDashed rt{transform:translateX(0.65rem)}@-moz-document url-prefix(){.title-container .title rt{margin-bottom:-0.4375rem}.vertical .title-container .title rt{margin-bottom:unset}.vertical .title-container .title u rt{margin-left:.1875rem}}.main[data-v-54b3864f]{padding:20px min(50px,4.5%) 80px}.title-container[data-v-54b3864f]{position:relative}.title-container .no[data-v-54b3864f]{white-space:nowrap}.title-container .title[data-v-54b3864f]> .graphCanvas{visibility:hidden}.title-container .title[data-v-54b3864f]> .graphCanvas .correctImage{mix-blend-mode:var(--drill-dark-mode-icon-blend);opacity:var(--drill-dark-mode-icon-alpha)}.title-container .title[data-v-54b3864f]> .graphCanvas .correctImage img{width:5rem;height:5rem}.mt-3[data-v-54b3864f],.mt-1[data-v-54b3864f]{display:flex;align-items:baseline}.child-container[data-v-54b3864f]{margin-left:2.375rem}.branch-container[data-v-54b3864f]{display:block}.middle-container:has(+.middle-container) .branch-container[data-v-54b3864f],.middle-container+.middle-container .branch-container[data-v-54b3864f]{margin-left:3rem}.branch-container[data-v-54b3864f]:has(+.branch-container),.branch-container+.branch-container[data-v-54b3864f]{margin-top:1rem}.middle-container[data-v-54b3864f]:has(>.no12),.branch-container[data-v-54b3864f]:has(>.no12){display:flex;align-items:baseline;position:relative}.middle-container[data-v-54b3864f]:has(>.no12):has(>.score-area),.branch-container[data-v-54b3864f]:has(>.no12):has(>.score-area){padding-bottom:calc(3.125rem + 10px)}.middle-container:has(>.no12) .score-area[data-v-54b3864f],.branch-container:has(>.no12) .score-area[data-v-54b3864f]{position:absolute;bottom:0}.vertical .middle-container[data-v-54b3864f]:has(>.no12):has(>.score-area),.vertical .branch-container[data-v-54b3864f]:has(>.no12):has(>.score-area){padding-bottom:0;padding-left:8.5rem}.vertical .middle-container:has(>.no12) .score-area[data-v-54b3864f],.vertical .branch-container:has(>.no12) .score-area[data-v-54b3864f]{position:absolute;left:0}.vertical[data-v-54b3864f]:not([class^=no]){max-height:calc(100vh - 80px);width:100vw;padding:0 40px 20px 0;margin:0 calc(50% - 50vw);writing-mode:vertical-rl;overflow-x:scroll}.vertical:not([class^=no]) .title-container[data-v-54b3864f]{position:relative}.vertical:not([class^=no]) .title-container .question-no[data-v-54b3864f],.vertical:not([class^=no]) .title-container .no[data-v-54b3864f]{text-orientation:upright;text-combine-upright:all;-webkit-text-combine:horizontal;width:fit-content;height:2.8rem;writing-mode:horizontal-tb}.vertical:not([class^=no]) .title-container .title[data-v-54b3864f]  .graphCanvas .manualCheckWrapper{position:absolute;top:55%}.vertical:not([class^=no]) .child-container[data-v-54b3864f]{margin-top:0rem}.vertical:not([class^=no]) .branch-container[data-v-54b3864f]{margin-top:.75rem}.score-area[data-v-54b3864f]{position:relative;width:100%;height:3.125rem;display:flex;justify-content:end;align-items:baseline;font-family:var(--bs-font-default);margin-top:10px}.score-area .score-num[data-v-54b3864f]{width:3.125rem;height:3.125rem;border:2px solid #000;font-size:2rem;display:flex;text-align:center;justify-content:center;align-items:center;line-height:3.125rem}.score-area .score-total[data-v-54b3864f]{font-size:1.2rem}.vertical .mt-3[data-v-54b3864f],.vertical .mt-1[data-v-54b3864f]{margin-top:0 !important}.vertical .score-area[data-v-54b3864f]{writing-mode:horizontal-tb;width:fit-content;height:100%;align-items:end;margin:0 10px}.inner_tabs[data-v-54b3864f]{display:grid;grid-template-columns:repeat(auto-fill, 64px);column-gap:.25em;border-style:none none solid none;border-color:var(--main-color);border-width:1px}.inner_tabs .tab[data-v-54b3864f]{padding:0 .3em;background-color:#fff;border-radius:16px 16px 0 0;border-style:solid solid none solid;border-color:var(--main-color);border-width:1px;text-align:center;font-size:1.5rem}.inner_tabs .tab.selected[data-v-54b3864f]{color:#fff;background-color:var(--main-color)}', ""]),
        t.exports = d
    },
    2170: function(t, e, n) {
        "use strict";
    ...
    2171: function(t, e, n) {
        var o = n(21)(!1);
        o.push([t.i, ".memo[data-v-54b3864f]{position:absolute;left:-40px;top:0;z-index:100;width:49px;height:42px;pointer-events:auto !important;cursor:pointer}.memo[data-v-54b3864f]:hover{transform:scale(1.08)}.memo.inactive[data-v-54b3864f]{display:none}.vertical .memo[data-v-54b3864f]{position:aobsolute;right:-1.5rem;top:-2.5rem}.vertical .memo.multiple[data-v-54b3864f]{position:absolute;width:42px;height:36px;right:3.2rem;top:-0.1rem}.vertical .memo.branch[data-v-54b3864f]{width:42px;height:36px;right:3rem;top:-0.1rem}", ""]),
        t.exports = o
    }
}]);
